...
- контролируемым benchmark/reference scan до глубокого authoring, где приоритет получают сильные GitHub-проекты, официальная документация и публичные эталонные системы мирового уровня
...
3. Затем выполните короткий reference scan, где основными источниками будут сильные GitHub-проекты, официальные документы и публичные эталоны; при необходимости система также спросит о ваших собственных референсах. Локальные файлы используются только для адаптации, приватности и совместимости.
